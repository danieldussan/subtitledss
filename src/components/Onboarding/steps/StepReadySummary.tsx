  ...
  return (
    <div className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-[13px] font-medium text-text-primary">
              {modelLabels[selections.model] || selections.model}
            </div>
          </div>
        </div>
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-[13px] font-medium text-text-primary">
              {langLabels[selections.language] || selections.language}
            </div>
          </div>
        </div>
        <div className="flex items-center gap-3">
      ...
      <div className="text-center text-[13px] text-text-secondary">
        Press{" "}
        <kbd className="px-1.5 py-0.5 bg-bg-surface border border-border-default rounded text-xs font-mono">
          Ctrl+Shift+S
        </kbd>{" "}
        to start capturing
      </div>
